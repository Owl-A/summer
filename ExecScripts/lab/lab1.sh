...
docker exec cont1 ip link set eth0 name wcont
docker exec cont1 ip link set wcont up

docker exec cont2 ip link set eth0 down
docker exec cont2 ip link set eth0 name wcont
docker exec cont2 ip link set wcont up

docker exec cont3 ip link set eth0 down
docker exec cont3 ip link set eth0 name wcont
docker exec cont3 ip link set wcont up
